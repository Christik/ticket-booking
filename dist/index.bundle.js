...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_styles_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/styles.less */ \"./src/styles/styles.less\");\n/* harmony import */ var _utilities_format_price__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities/format-price */ \"./src/utilities/format-price.js\");\n/* harmony import */ var _utilities_index_of_element__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilities/index-of-element */ \"./src/utilities/index-of-element.js\");\n/* harmony import */ var _templates_order_list_hbs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./templates/order-list.hbs */ \"./src/templates/order-list.hbs\");\n/* harmony import */ var _templates_order_list_hbs__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_templates_order_list_hbs__WEBPACK_IMPORTED_MODULE_3__);\nvar _pricesMap;\n\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && iter[Symbol.iterator] != null || iter[\"@@iterator\"] != null) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== \"undefined\" && arr[Symbol.iterator] || arr[\"@@iterator\"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\n\n // Настройки\n\nvar settings = {\n  availableClass: 'seat_available',\n  selectedClass: 'seat_selected',\n  reservedClass: 'seat_reserved',\n  expensiveClass: 'seat_expensive',\n  inexpensiveClass: 'seat_inexpensive',\n  cheatClass: 'seat_cheap',\n  seatElement: '.seats .seat',\n  rowElement: '.seats__row',\n  orderListElement: '[data-order-list]',\n  totalElement: '[data-total]'\n}; // Вилка цен\n\nvar pricesMap = (_pricesMap = {}, _defineProperty(_pricesMap, settings.expensiveClass, 3000), _defineProperty(_pricesMap, settings.inexpensiveClass, 1500), _defineProperty(_pricesMap, settings.cheatClass, 1000), _pricesMap); // Зал с креслами\n\nvar auditorium = document.querySelector('.auditorium'); // Получить номер ряда\n\nvar getRowNumber = function getRowNumber(seat) {\n  var row = seat.closest(settings.rowElement);\n  var index = (0,_utilities_index_of_element__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(row);\n  return index + 1;\n}; // Получить номер места\n\n\nvar getSeatNumber = function getSeatNumber(seat) {\n  return seat.textContent;\n}; // Получить цену указанного места\n\n\nvar getPriceOfSeat = function getPriceOfSeat(seat) {\n  var tariffs = Object.keys(pricesMap);\n\n  for (var _i = 0, _tariffs = tariffs; _i < _tariffs.length; _i++) {\n    var tariff = _tariffs[_i];\n\n    if (seat.classList.contains(tariff)) {\n      return pricesMap[tariff];\n    }\n  }\n\n  return null;\n}; // Получить все места, выбранные пользователем\n\n\nvar getSeatsSelected = function getSeatsSelected() {\n  var seatsSelected = auditorium.querySelectorAll(\".\".concat(settings.selectedClass));\n  return seatsSelected;\n}; // Получить общую сумму\n\n\nvar getTotal = function getTotal() {\n  var seatsSelected = getSeatsSelected();\n  var total = 0;\n  seatsSelected.forEach(function (seat) {\n    var price = getPriceOfSeat(seat);\n    total += price;\n  });\n  return total;\n}; // Отметить выбранные кресла, согласно данным из localStorage \n\n\nvar setSeatsSelected = function setSeatsSelected() {\n  var seatsSelectedPosition = JSON.parse(localStorage.getItem('seatsSelectedPosition'));\n\n  if (seatsSelectedPosition) {\n    seatsSelectedPosition.forEach(function (position) {\n      var _position = _slicedToArray(position, 2),\n          rowNumber = _position[0],\n          seatNumber = _position[1];\n\n      var row = document.querySelector(\"\".concat(settings.rowElement, \":nth-child(\").concat(rowNumber, \")\"));\n      var cell = row.children[seatNumber - 1];\n      var seat = cell.querySelector(settings.seatElement);\n      toggleSeatClass(seat);\n    });\n  }\n}; // Сохранить в locasStorage расположение выбранных пользователем мест\n\n\nvar saveSeatsSelectedPosition = function saveSeatsSelectedPosition() {\n  var seatsSelected = getSeatsSelected(); // Получаем массив с позициями выбранных пользователем мест.\n  // Каждая позиция - массив с номером ряда и номером места\n\n  var seatsSelectedPosition = _toConsumableArray(seatsSelected).map(function (seat) {\n    var seatNumber = getSeatNumber(seat);\n    var rowNumber = getRowNumber(seat);\n    return [rowNumber, seatNumber];\n  });\n\n  localStorage.setItem('seatsSelectedPosition', JSON.stringify(seatsSelectedPosition));\n}; // Обновить общую сумму\n\n\nvar updateTotal = function updateTotal() {\n  var total = getTotal();\n  var totalElement = document.querySelector(settings.totalElement);\n  totalElement.textContent = (0,_utilities_format_price__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(total);\n}; // Обновить информацию о заказе\n\n\nvar updateOrder = function updateOrder() {\n  var orderList = document.querySelector(settings.orderListElement);\n  var seatsSelected = getSeatsSelected();\n  var orderRows = [];\n  seatsSelected.forEach(function (seat) {\n    var orderRow = {\n      rowNumber: getRowNumber(seat),\n      seatNumber: getSeatNumber(seat),\n      price: (0,_utilities_format_price__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(getPriceOfSeat(seat))\n    };\n    orderRows.push(orderRow);\n  });\n  var template = _templates_order_list_hbs__WEBPACK_IMPORTED_MODULE_3___default()({\n    orderRows: orderRows\n  });\n  orderList.innerHTML = template;\n}; // Переключение классов кресел\n\n\nvar toggleSeatClass = function toggleSeatClass(seat) {\n  seat.classList.toggle(settings.availableClass);\n  seat.classList.toggle(settings.selectedClass);\n}; // Делегирование клика по креслу в зале\n\n\nauditorium.addEventListener('click', function (event) {\n  var seat = event.target.closest(\".\".concat(settings.availableClass, \", .\").concat(settings.selectedClass));\n\n  if (seat) {\n    toggleSeatClass(seat);\n    updateOrder();\n    updateTotal();\n    saveSeatsSelectedPosition();\n  }\n}); // Инициализация\n\nsetSeatsSelected();\nupdateOrder();\nupdateTotal();\n\n//# sourceURL=webpack://webpack/./src/index.js?");

/***/ }),

/***/ "./src/utilities/format-price.js":
/*!***************************************!*\
  !*** ./src/utilities/format-price.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (number) {\n  var string = String(number);\n  var formatNumber = '';\n\n  for (var i = 0; i < string.length; i++) {\n    var currentDigit = string[string.length - 1 - i];\n    formatNumber = \"\".concat(currentDigit).concat(formatNumber);\n\n    if ((i + 1) % 3 === 0) {\n      formatNumber = \" \".concat(formatNumber);\n    }\n  }\n\n  return formatNumber;\n});\n\n//# sourceURL=webpack://webpack/./src/utilities/format-price.js?");

/***/ }),

/***/ "./src/utilities/index-of-element.js":
/*!*******************************************!*\
  !*** ./src/utilities/index-of-element.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && iter[Symbol.iterator] != null || iter[\"@@iterator\"] != null) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (element) {\n  var parent = element.parentElement;\n  var elements = parent.children;\n\n  var array = _toConsumableArray(elements);\n\n  var index = array.indexOf(element);\n  return index;\n});\n\n//# sourceURL=webpack://webpack/./src/utilities/index-of-element.js?");
...
/***/ "./src/templates/order-list.hbs":
/*!**************************************!*\
  !*** ./src/templates/order-list.hbs ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("var Handlebars = __webpack_require__(/*! ../../node_modules/handlebars/runtime.js */ \"./node_modules/handlebars/runtime.js\");\nfunction __default(obj) { return obj && (obj.__esModule ? obj[\"default\"] : obj); }\nmodule.exports = (Handlebars[\"default\"] || Handlebars).template({\"1\":function(container,depth0,helpers,partials,data) {\n    var stack1;\n\n  return ((stack1 = container.invokePartial(__webpack_require__(/*! ./order-row.hbs */ \"./src/templates/order-row.hbs\"),depth0,{\"name\":\"./order-row.hbs\",\"data\":data,\"indent\":\"    \",\"helpers\":helpers,\"partials\":partials,\"decorators\":container.decorators})) != null ? stack1 : \"\");\n},\"compiler\":[8,\">= 4.3.0\"],\"main\":function(container,depth0,helpers,partials,data) {\n    var stack1, lookupProperty = container.lookupProperty || function(parent, propertyName) {\n        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {\n          return parent[propertyName];\n        }\n        return undefined\n    };\n\n  return ((stack1 = lookupProperty(helpers,\"each\").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,\"orderRows\") : depth0),{\"name\":\"each\",\"hash\":{},\"fn\":container.program(1, data, 0),\"inverse\":container.noop,\"data\":data,\"loc\":{\"start\":{\"line\":1,\"column\":0},\"end\":{\"line\":3,\"column\":9}}})) != null ? stack1 : \"\");\n},\"usePartial\":true,\"useData\":true});\n\n//# sourceURL=webpack://webpack/./src/templates/order-list.hbs?");

/***/ }),

/***/ "./src/templates/order-row.hbs":
/*!*************************************!*\
  !*** ./src/templates/order-row.hbs ***!
  \*************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("var Handlebars = __webpack_require__(/*! ../../node_modules/handlebars/runtime.js */ \"./node_modules/handlebars/runtime.js\");\nfunction __default(obj) { return obj && (obj.__esModule ? obj[\"default\"] : obj); }\nmodule.exports = (Handlebars[\"default\"] || Handlebars).template({\"compiler\":[8,\">= 4.3.0\"],\"main\":function(container,depth0,helpers,partials,data) {\n    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.hooks.helperMissing, alias3=\"function\", alias4=container.escapeExpression, lookupProperty = container.lookupProperty || function(parent, propertyName) {\n        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {\n          return parent[propertyName];\n        }\n        return undefined\n    };\n\n  return \"<li class=\\\"order\\\">\\r\\n    <div class=\\\"order__label\\\">\\r\\n        Ряд \"\n    + alias4(((helper = (helper = lookupProperty(helpers,\"rowNumber\") || (depth0 != null ? lookupProperty(depth0,\"rowNumber\") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{\"name\":\"rowNumber\",\"hash\":{},\"data\":data,\"loc\":{\"start\":{\"line\":3,\"column\":12},\"end\":{\"line\":3,\"column\":25}}}) : helper)))\n    + \", \\r\\n        место \"\n    + alias4(((helper = (helper = lookupProperty(helpers,\"seatNumber\") || (depth0 != null ? lookupProperty(depth0,\"seatNumber\") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{\"name\":\"seatNumber\",\"hash\":{},\"data\":data,\"loc\":{\"start\":{\"line\":4,\"column\":14},\"end\":{\"line\":4,\"column\":28}}}) : helper)))\n    + \"\\r\\n    </div>\\r\\n    <div class=\\\"order__price\\\">\\r\\n        \"\n    + alias4(((helper = (helper = lookupProperty(helpers,\"price\") || (depth0 != null ? lookupProperty(depth0,\"price\") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{\"name\":\"price\",\"hash\":{},\"data\":data,\"loc\":{\"start\":{\"line\":7,\"column\":8},\"end\":{\"line\":7,\"column\":17}}}) : helper)))\n    + \" ₽\\r\\n    </div>\\r\\n</li><!--.order-->\\r\\n\";\n},\"useData\":true});\n\n//# sourceURL=webpack://webpack/./src/templates/order-row.hbs?");
...
"use strict";
eval("module.exports = __webpack_require__.p + \"704759c039c4cb93a0a7.svg\";\n\n//# sourceURL=webpack://webpack/./src/images/user.svg?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("344b27a133d74ecdc2e9")
/******/ 	})();
/******/ 	
